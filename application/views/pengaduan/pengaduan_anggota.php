		...
		<div class="row">
			<div class="col-12">
				<div class="card">
					...
					<!-- /.card-header -->
					<div class="card-body">
						<table id="tbl_pen_anggota" class="table table-bordered table-striped table-hover">
							<thead>
								<tr class="bg-info">
									<th>No</th>
                  <th>Nama</th>
    ...
    var mapOptions = {
      zoom: 16,
        ...
        function edit_laporan(id){
          ...
          $.ajax({
            url : "<?php echo site_url('pengaduan_anggota/view_pengaduan')?>/",
            data:"id="+id,
            dataType : 'json',
            type : 'POST',
...
$(document).ready(function() {
    ...
    //datatables
    table =$("#tbl_pen_anggota").DataTable({
      "responsive": true,
      "autoWidth": false,
      "language": {
        ...
        "ajax": {
          "url": "<?php echo site_url('pengaduan_anggota/ajax_list')?>",
          "type": "POST"
        },
...
function Konfirmasi()
{
    ...
    var url = "<?php echo site_url('pengaduan_anggota/konfirmasi_pengaduan')?>";//arahin ke kategori update
